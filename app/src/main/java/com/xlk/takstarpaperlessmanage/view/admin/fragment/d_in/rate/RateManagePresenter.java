 ...
 * @desc
 */
public class RateManagePresenter extends BasePresenter<RateManageContract.View> implements RateManageContract.Presenter {
    ...
    public RateManagePresenter(RateManageContract.View view) {
        super(view);
    }
