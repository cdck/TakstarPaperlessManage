...
//        canvas.drawCircle(x + mItemWidth / 2, mItemHeight - 3 * mPadding, mPointRadius, mPointPaint);
        if (calendar.hasScheme()) {
            ...
            canvas.drawCircle(x + mItemWidth - 3 * mPadding - mPointRadius, 3 * mPadding + mPointRadius, mPointRadius, mPointPaint);
        }
    }
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, boolean hasScheme, boolean isSelected) {
        ...
        if (isSelected) {
            ...
            canvas.drawText(calendar.getScheme(), cx, mTextBaseLine + mItemHeight / 10, mSelectedLunarTextPaint);
        } else if (hasScheme) {
            ...
            canvas.drawText(calendar.getScheme(), cx, mTextBaseLine + mItemHeight / 10, mSchemeLunarTextPaint);
        } else {
            canvas.drawText(String.valueOf(calendar.getDay()), cx, mTextBaseLine + top,
